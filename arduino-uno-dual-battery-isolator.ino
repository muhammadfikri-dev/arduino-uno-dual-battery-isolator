/**
 * =========================================================================================
 * Project     : Arduino Uno Intelligent Dual-Battery Marine/RV Isolator & Split Charger
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Smart battery isolator managing starter and auxiliary lithium/AGM batteries, prioritizing starter cranking voltage, bi-directional emergency jump-start, and telemetry.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Intelligent Dual-Battery Marine/RV Isolator & Split Charger"));
